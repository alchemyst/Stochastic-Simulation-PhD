...
The OpenModelica project provides an Open Source implementation of a
...
Simulation of a distillation column has been done before in
Modelica~\cite{citeulike:3660679}.  However, the modelling strategy
followed here is more modular, and abstracts the thermodynamics to the
streams, allowing easy interfacing with an external thermodynamics package.
...
1915~\citep{hougen1972seven}.  Unit operations lend themselves to an
...
%TODO: Mention something about the phase rule and degrees of freedom
...
The extension to the solution methodology is so great that it may not
