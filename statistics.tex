...
The standard deviation of the sample (written $s_N$ for a sample size of $N$) can be naively calculated by analogy to the defintion of the variance as
\begin{equation}
...
A process for which the parameters remain constant over time is called an ergodic process
