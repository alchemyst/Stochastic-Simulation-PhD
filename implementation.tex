...
The techniques described in section \ref{sec:lit:segmentation} were all implemented in a Python module called \modulename{Python}{segmentation}.
...
It was decided to bundle the extensive properties of the stream and the
...
A single generic plate model was developed that allows for a material
